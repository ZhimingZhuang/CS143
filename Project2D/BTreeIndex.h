...
class BTreeIndex {
  ...
  */
  IndexCursor recurFindleaf(PageId pid, int searchKey, PageId traverse[], int num);
  
  RC recurinsert(PageId traverse[], int& level, int key, PageId pid);

  /*new function*/
  PageId getleafnextpid(PageId pid);
    
  PageId getendpid();

  int getleafkeycount(PageId pid);
